...
public class Util 
{
	...
	/**
	 * Skalira jednu 2D float matricu u drugu, kosinusno interpolirajući vrijednosti
	 * @param source izvorna matrica
	 * @param destination matrica u koju će biti upisane vrijednosti za njene dimenzije
	 */
	...
	/**
	 * Govori da li je ucitavanje slike putem {@link rafgfxlib.Util#loadImage loadImage()} ijednom zakazalo od pocetka programa, ili pod posljednjeg reseta
	 * @return - da li se desio ijedan fail
	 */
	...
	/**
	 * Resetuje stanje koje {@link rafgfxlib.Util#hasImageLoadingFailed() hasImageLoadingFailed()} cita na {@code false}
	 */
	...
	/**
	 * Kosinusna interpolacija između dva int broja
	 * @param a počatak opsega
	 * @param b kraj opsega
	 * @param x faktor od 0 do 1
	 * @return interpolirana float vrijednost
	...
	/**
	 * Kosinusna interpolacija između dva float broja
	 * @param a počatak opsega
	 * @param b kraj opsega
	 * @param x faktor od 0 do 1
	 * @return interpolirana float vrijednost
	...
	/**
	 * Oganicava opseg date vrijednosti na [0-255]
	 * @param value - vrijednost koju je potrebno ograniciti
	 * @return vrijednost od 0 do 255 (inclusive)
	 */
	...
	/**
	 * Ogranicava opseg date vrijednosti prema zadatom minimumu i maksimumu
	 * @param value - vrijednost koju je potrebno ograniciti
	 * @param min - zeljeni minimum
	 * @param max - zeljeni maksimum
	 * @return - vrijednost od {@code min} do {@code max}
	 */
	...
	/**
	 * Oganicava opseg date vrijednosti na [0-1]
	 * @param value - vrijednost koju je potrebno ograniciti
	 * @return vrijednost od 0 do 1 (inclusive)
	 */
	...
	/**
	 * Helper za upisivanje RGB vrijednosti u array
	 * @param array - array velicine 3, ako je {@code null} bice kreiran novi
	 * @param r - crveni kanal [0-255]
	 * @param g - zeleni kanal [0-255] 
	 * @param b - plavi kanal [0-255]
	 * @return - popunjen array (isti koji je proslijedjen, ili novi ako je {@code array} bilo {@code null}
	 */
	...
	/**
	 * Helper za kreiranje novog arraya sa RGB vrijednostima
	 * @param r - crveni kanal [0-255]
	 * @param g - zeleni kanal [0-255] 
	 * @param b - plavi kanal [0-255]
	 * @return - popunjen array od 3 elementa
	 */
	...
	/**
	 * Helper za kreiranje novog arraya sa RGBA vrijednostima
	 * @param r - crveni kanal [0-255]
	 * @param g - zeleni kanal [0-255] 
	 * @param b - plavi kanal [0-255]
	 * @param a - alpha kanal [0-255]
	 * @return - popunjen array od 4 elementa
	 */
	...
	/**
	 * Helper za upisivanje RGBA vrijednosti u array
	 * @param array - array velicine 4, ako je {@code null} bice kreiran novi
	 * @param r - crveni kanal [0-255]
	 * @param g - zeleni kanal [0-255] 
	 * @param b - plavi kanal [0-255]
	 * @return - popunjen array (isti koji je proslijedjen, ili novi ako je {@code array} bilo {@code null}
	...
	/**
	 * Helper za konverziju HTML heksadecimalne notacije boja u RGB array
	 * @param hex - heksadecimalni string u HTML notaciji, {@code #} na pocetku je opcion
	 * @return - array od 3 elementa, popunjen bojom iz hex stringa
	 */
	...
	/**
	 * Helper za konverziju HTML heksadecimalne notacije boja u RGB array
	 * @param array - array od 3 elementa koji ce biti popunjen, ili {@code null} da se napravi novi
	 * @param hex - heksadecimalni string u HTML notaciji, {@code #} na pocetku je opcion
	 * @return - array od 3 elementa, popunjen bojom iz hex stringa
	 */
	...
	/**
	 * Helper za konverziju HTML heksadecimalne notacije boja u RGBA array
	 * @param hex - heksadecimalni string u HTML notaciji, {@code #} na pocetku je opcion
	 * @return - array od 4 elementa, popunjen bojom iz hex stringa
	 */
	...
	/**
	 * Helper za konverziju HTML heksadecimalne notacije boja u RGBA array
	 * @param array - array od 4 elementa koji ce biti popunjen, ili {@code null} da se napravi novi
	 * @param hex - heksadecimalni string u HTML notaciji, {@code #} na pocetku je opcion
	 * @return - array od 4 elementa, popunjen bojom iz hex stringa
	 */
